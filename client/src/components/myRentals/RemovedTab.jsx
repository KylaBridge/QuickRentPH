            ...
            <div className="flex-1 flex flex-col">
                <div className="mt-4 overflow-x-auto overflow-y-auto pr-4">
                    ...
                    {removedItems.map((item) => (
                        <div key={item.id} className="grid grid-cols-5 gap-4 items-center pl-2 pr-4 pt-2 pb-2 bg-white rounded-lg shadow-sm hover:bg-gray-100 transition-colors duration-150">
                            ...
                            <div className="col-span-1.5 text-center">
                                <p className="col-span-1.5 text-sm text-center font-medium text-gray-900">{item.item}</p>
                                {/*<p className="col-span-1.5 text-center text-sm text-gray-500">{item.model}</p>*/}
                            </div>
                            <div className="col-span-1.5 text-sm text-center text-black">{item.category}</div>
                            ...
                            <div className="col-span-1.5 text-center flex justify-center space-x-4">
                                <button
                                    ...
                                    style={{ minWidth: '48px' }}
                                >
                                    <svg className="w-5 h-5 mb-1 mt-1" fill="none" stroke="#6C4BF4" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button
                                    ...
                                    style={{ minWidth: '48px' }}
                                >
                                    <svg className="w-5 h-5 mb-2" fill="none" stroke="#6C4BF4" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
