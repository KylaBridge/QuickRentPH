            ...
            >
              ...
              <div className="col-span-1 flex justify-center">
                <div className="relative w-35 row-dropdown-container">
                  <button
                    onClick={() =>
                      handleRowDropdownToggle(item.id, "availability")
                    }
                  ...
                  {rowDropdown[`${item.id}-availability`] && (
                    <div
                      ...
                      style={{ width: "100%" }}
                    >
                      {["Available", "Unavailable", "Rented Out"].map(
                        (option) => (
                          <div
                            key={option}
                            onClick={() =>
                              handleRowSelect(item.id, "availability", option)
                            }
                            style={{
                              color: "black",
                              fontWeight: "normal",
                    ...
                    >
                      {["Active", "Inactive"].map((option) => (
                        <div
                          key={option}
                          onClick={() =>
                            handleRowSelect(item.id, "status", option)
                          }
                          style={{
                            color: "black",
                            fontWeight: "normal",
