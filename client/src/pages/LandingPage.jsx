          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              <p className="text-base sm:text-lg lg:text-lg xl:text-2xl text-gray-700 leading-relaxed max-w-2xl font-poppins">
                QuickRent connects people with items for rent to those who need
                them, making access easy, secure, and affordable.
              </p>
              <button
                onClick={checkUser}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed font-poppins">
                Have something others might need temporarily? List it on
                QuickRent with photos, details, and your rental price. You
                control availability and terms.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed font-poppins">
                Browse by category, search by keyword, or filter by location to
                discover items available for rent near you.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed font-poppins">
                Select your preferred dates, confirm availability, and send a
                rental request to the item owner.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed font-poppins">
                Finalize the rental through in-app messaging and choose a secure
                payment method-ensuring a smooth and safe transaction for both
                parties.
              </p>
            </div>
          </div>
